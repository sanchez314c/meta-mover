...
"x86_64\-linux-7\.0\.0\-28\-generic" or
	die "Errno architecture (x86_64\-linux-7\.0\.0\-28\-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
